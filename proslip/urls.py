...
from .views import CustomLoginView, ProfilePageView, UserRegistrationView, CustomLogoutView, StaffListView,DocView, PayslipUploadView, DownloadPDFView, PDFView, UpdateProfileView
from . import views
